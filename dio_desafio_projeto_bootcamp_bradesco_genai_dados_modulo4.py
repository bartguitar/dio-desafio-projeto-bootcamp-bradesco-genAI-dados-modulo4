# -*- coding: utf-8 -*-
"""dio-desafio-projeto-bootcamp-bradesco-genAI-dados-modulo4.ipynb
...
# ETAPA 1 - #### Gravação de Áudio Com Python (e Uma Pitada de JavaScript) ###
...
# ETAPA 2 - ### Reconhecimento de Fala com Whisper (OpenAI) ###
...
# ETAPA 3 - ### Integração com a API do ChatGPT ###
...
# ETAPA 4 - ### Sintetizando a Resposta do ChatGPT Como Voz (gTTS) ###
!pip install gTTS
